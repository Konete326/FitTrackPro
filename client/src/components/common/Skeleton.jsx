...
function Skeleton({ type = 'text', count = 1, className = '' }) {
  ...
  const types = {
    ...
    card: (
      <div className={`bg-white dark:bg-gray-800 rounded-xl p-5 shadow-xs ${className}`}>
    ...
    table: (
      <div className={`bg-white dark:bg-gray-800 rounded-xl shadow-xs overflow-hidden ${className}`}>
