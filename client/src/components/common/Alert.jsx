...
function Alert({ variant = 'info', title, children, dismissible, onDismiss, className = '' }) {
  return (
    <div className={`border rounded-lg p-4 flex items-start gap-3 ${alertVariants[variant]} ${className}`}>
      {variant === 'success' && (
