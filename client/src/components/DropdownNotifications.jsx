          ...
          <ul>
            <li className="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">💪 <span className="font-medium text-gray-800 dark:text-gray-100">Workout reminder</span> Time to log your workout for today!</span>
                <span className="block text-xs font-medium text-gray-400 dark:text-gray-500">Just now</span>
              </Link>
            </li>
            <li className="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">🎯 <span className="font-medium text-gray-800 dark:text-gray-100">Goal milestone</span> You're 80% towards your weekly goal!</span>
                <span className="block text-xs font-medium text-gray-400 dark:text-gray-500">Today</span>
              </Link>
            </li>
            <li className="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">🏆 <span className="font-medium text-gray-800 dark:text-gray-100">Achievement unlocked!</span> You completed 7 workouts this week.</span>
                <span className="block text-xs font-medium text-gray-400 dark:text-gray-500">Yesterday</span>
              </Link>
            </li>
          </ul>
        </div>
